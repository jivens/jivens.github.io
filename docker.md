...
Go to [Docker](https://www.docker.com/get-started) and download and install Docker Desktop.
...
Docker Desktop will run on startup, and then can be accessed via the desktop gui or via the command line.  If you want to be sure that Docker is installed correctly, you can run this command from the command line.
